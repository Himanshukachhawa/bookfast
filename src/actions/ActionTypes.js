...
export const TRIP_SUB_TYPE = 'TRIP_SUB_TYPE'
export const KM = 'KM'
...
export const CURRENT_SUB_ID = 'CURRENT_SUB_ID'
export const SUB_RIDES = 'SUB_RIDES'
export const SUB_EXPIRE_DATE = 'SUB_EXPIRE_DATE'
